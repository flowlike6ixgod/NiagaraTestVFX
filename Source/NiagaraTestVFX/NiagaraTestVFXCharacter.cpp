...
ANiagaraTestVFXCharacter::ANiagaraTestVFXCharacter()
{
...
void ANiagaraTestVFXCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ANiagaraTestVFXCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ANiagaraTestVFXCharacter::MoveForward(float Value)
{
...
void ANiagaraTestVFXCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
